...
const localStorageKey = '_recipeBox_data'; 
const recipes = [
  {
...
class LocalStorageManager {
  ...
  get() {
    let currentState = localStorage.getItem(localStorageKey);
...
export default new Vuex.Store({
  ...
  mutations: {
    loadData(state) {
      ...
      state.recipes = LSM.get(localStorageKey)
    },
    addRecipe(state, payload) {
      state.recipes = [...state.recipes,payload]
      LSM.set(state.recipes);
    },
